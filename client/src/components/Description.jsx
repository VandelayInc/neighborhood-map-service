    ...
    if (this.state.showMoreInfo) {
      return (
        <div>
          ...
          <div className='div-neighborhood-more-info'>
            ...
            <span className='div-neighborhood-clickable' onClick={this.toggleShowMore}>Hide &uarr;</span>
          </div>
        </div>
      );
    } else {
      return (
        <div>
          ...
          <p>{ this.props.listing.neighborhood_overview }</p>
          <div className='div-neighborhood-more-info'>
            <span className='div-neighborhood-clickable' onClick={this.toggleShowMore}>Read more about the neighborhood &darr;</span>
          </div>
        </div>
      );
    }
